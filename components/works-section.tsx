...
export function WorksSection() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Plateforme de gestion de stock avec calcul automatique en temps réel, génération de factures et bons de commande PDF, et suivi des mouvements de stock.",
      ...
      features: ["Calcul automatique", "Génération PDF", "Alertes stock", "Historique mouvements"],
